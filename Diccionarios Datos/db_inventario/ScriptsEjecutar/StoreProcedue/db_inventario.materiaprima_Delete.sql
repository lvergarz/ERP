...
BEGIN
	...
	BEGIN
	Update  [db_inventario].[tb_materiaprima] Set EstadoExistencia = 'E' Where id_materia = @id_materia ;
	END
	ELSE
	BEGIN
	Delete  [db_inventario].[tb_materiaprima] Where id_materia = @id_materia ;
	END
	 IF @@ROWCOUNT = 0
	 BEGIN
	   SET @resultado='00006';
