...
BEGIN
	...
	BEGIN
	Update  [db_manufactura].[tb_datalleordenmprima] Set EstadoExistencia = 'E' Where id_datelleorden = @id_datelleorden ;
	END
	ELSE
	BEGIN
	Delete  [db_manufactura].[tb_datalleordenmprima] Where id_datelleorden = @id_datelleorden ;
	END
	 IF @@ROWCOUNT = 0
	 BEGIN
	   SET @resultado='00006';
