...
BEGIN
	...
	BEGIN
	Update  [db_manufactura].[tb_cabeceraorden] Set EstadoExistencia = 'E' Where uid_cabecera = @uid_cabecera ;
	END
	ELSE
	BEGIN
	Delete  [db_manufactura].[tb_cabeceraorden] Where uid_cabecera = @uid_cabecera ;
	END
	 IF @@ROWCOUNT = 0
	 BEGIN
	   SET @resultado='00006';
