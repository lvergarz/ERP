...
BEGIN
	...
	BEGIN
	Update  [db_manufactura].[tb_datallegfprima] Set EstadoExistencia = 'E' Where uid_datelleordengf = @uid_datelleordengf ;
	END
	ELSE
	BEGIN
	Delete  [db_manufactura].[tb_datallegfprima] Where uid_datelleordengf = @uid_datelleordengf ;
	END
	 IF @@ROWCOUNT = 0
	 BEGIN
	   SET @resultado='00006';
